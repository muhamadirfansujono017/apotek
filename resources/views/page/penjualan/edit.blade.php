            ...
            <div class="p-10">
                ...
                <div class="mb-8 p-6 bg-amber-50 border-l-4 border-amber-400 rounded-2xl flex gap-4">
                    ...
                    <p class="text-xs font-medium text-amber-800 leading-relaxed">
                        <span class="font-bold uppercase italic">Peringatan:</span> Fitur edit ini hanya untuk mengubah data pembayaran dan tanggal. Untuk mengubah item obat, disarankan hapus penjualan dan buat baru agar stok <span class="font-bold">Apotek JUJU</span> tetap akurat.
                    </p>
                </div>
